...
import de.uni_due.paluno.elefant.featuremodel_extended.Activity;
import de.uni_due.paluno.elefant.featuremodel_extended.Feature;
import de.uni_due.paluno.elefant.featuremodel_extended.FeatureRequirement;
        ...
        while(newActivityFound){
            ...
            for(int i=0;i<activities.size();++i){
                ...
                if(!treatedActivities.contains(activity)){
                    ...
                    for(FeatureRequirement fr:activity.getActivity().getFeatureRequirements()){
